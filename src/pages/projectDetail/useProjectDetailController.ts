...
export const useProjectDetailController = () => {
  ...
  const ocrWorkspaceProps = {
    ...
    onDeleteImages: actions.handleDeleteImages,
    onClearAnnotationsForImages: actions.handleClearAnnotationsForImages,
    onSetValidationForImages: actions.handleSetValidationForImages,
    onRunInferenceForImages: actions.handleRunInferenceForImages,
